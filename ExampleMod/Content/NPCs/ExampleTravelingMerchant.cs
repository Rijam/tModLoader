...
namespace ExampleMod.Content.NPCs
{
	...
	class ExampleTravelingMerchant : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			NPCID.Sets.NPCPortraits.Add(Type, NPCID.Sets.PrioritizedPortrait().With(NPCID.Sets.ShimmeredPortraitCondition, NPCID.Sets.BasicPortrait("ExampleMod/Content/NPCs/Portraits/ExampleTravelingMerchant_Shimmer")).Default(NPCID.Sets.BasicPortrait("ExampleMod/Content/NPCs/Portraits/ExampleTravelingMerchant")));
